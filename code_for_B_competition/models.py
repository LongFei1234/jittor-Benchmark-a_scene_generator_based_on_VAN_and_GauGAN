...
class SubDiscriminator(nn.Module):
    def __init__(self):
        ...
        padw = 1
        self.con1 = nn.Conv2d(6, 128, kernel_size=4, stride=2, padding=padw)
...
class SPADE(nn.Module):
    def __init__(self, norm_nc):
        ...
        self.mlp_shared = nn.Sequential(
            nn.Conv2d(3, nhidden, kernel_size=kernal_size, padding=padding),
            nn.LeakyReLU(0.2)
        )
...
class Generator(nn.Module):
    def __init__(self, pad_size, random_input_hid_dim):
        ...
        self.seg_down1 = UDown(3, 64)
        self.seg_down2 = UDown(64, 128)
        self.VAN1 = nn.Sequential(Block(dim=128))
        self.ln1 = nn.LayerNorm([128, 96, 128])
        self.seg_down3 = UDown(128, 128)
        self.seg_down4 = UDown(128, 256)
        self.VAN2 = nn.Sequential(Block(dim=256))
        self.ln2 = nn.LayerNorm([256, 24, 32])
